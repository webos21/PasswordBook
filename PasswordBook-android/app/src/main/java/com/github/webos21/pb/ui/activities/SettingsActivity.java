...
import com.github.webos21.pb.events.CryptoEvent;
import com.github.webos21.pb.events.DBExportEvent;
import com.github.webos21.pb.runnable.DBExportRunnable;
import com.github.webos21.pb.ui.views.SelectorItem;
...
public class SettingsActivity extends MaterialSettingsActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addItem(new HeaderItem(getFragment()).setTitle(getString(R.string.security)));
        addItem(new CheckboxItem(getFragment(), UserDefault.kNeedPasswordWhenLaunch).setTitle(getString(R.string.need_password_when_launch)).setOnCheckedChangeListener(new CheckboxItem.OnCheckedChangeListener() {
            @Override
        ...
        quickSwitcher = new TextItem(getFragment(), "quick_pass").setTitle(title).setOnclick(new TextItem.OnClickListener() {
            @Override
        ...
        addItem(new TextItem(getFragment(), "change_password").setTitle(getString(R.string.change_master_password)).setOnclick(new TextItem.OnClickListener() {
            @Override
            public void onClick(TextItem textItem) {
        ...
        addItem(new HeaderItem(getFragment()).setTitle(getString(R.string.puff_secure_keyboard)));
        addItem(new TextItem(getFragment(), "ime").setTitle(getString(R.string.enable_puff_secure_keyboard)). setOnclick(new TextItem.OnClickListener() {
            @Override
            public void onClick(TextItem textItem) {
        ...
        addItem(new HeaderItem(getFragment()).setTitle(getString(R.string.database)));
        addItem(new TextItem(getFragment(), "database").setTitle(getString(R.string.export_database))
        ...
        addItem(new HeaderItem(getFragment()).setTitle(getString(R.string.about)));
        addItem(new TextItem(getFragment(), "about").setTitle(getResources().getString(R.string.about_puff_title)).setOnclick(new TextItem.OnClickListener() {
            @Override
            public void onClick(TextItem textItem) {
